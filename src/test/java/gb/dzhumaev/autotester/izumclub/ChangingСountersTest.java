...
public class ChangingСountersTest extends TestCongicuration {
    ...
    public void t1() throws InterruptedException {
        ...
        assertEquals("1", getText(COMPARE_COUNTER));
    }
    ...
    public void t2() throws InterruptedException {
        ...
        tryClick(POPUP_WINDOW_CLOSE);
        assertEquals("2", getText(COMPARE_COUNTER));
    ...
    public void t3() throws InterruptedException {
        ...
        tryClick(POPUP_WINDOW_CLOSE);
        assertEquals("1", getText(FAVORITE_COUNTER));
    }
    ...
    public void t4() throws InterruptedException {
        ...
        tryClick(POPUP_WINDOW_CLOSE);
        assertEquals("2", getText(FAVORITE_COUNTER));
    ...
    public void t5() throws InterruptedException {
        getDriver().get(URL_CATEGORY_SMARTPHONES);
        assertEquals("0", getText(CART_COUNTER));

        click(CART_ON_CARD, CARD_1);
        tryClick(POPUP_WINDOW_CLOSE);
        assertEquals("1", getText(CART_COUNTER));
    }
}
